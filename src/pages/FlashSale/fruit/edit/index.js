        ...
        {!isList ?
            ...
            >
                ...
                <Wrapper>
                    ...
                    <Form.Item rules={[{ required: true, message: 'Kho hàng lưu động không được để trống' }]} name="booth" label={<span style={{ color: '#748CAD' }}>Kho hàng lưu động</span>}>
                        ...
                        >
                            <Option key="-7" value='CHECKALL'>Chọn tất cả</Option>
                ...
                <Row>
                    <div className="w-max flex justify-end mt-3 custom-button">
                        <Space size={24}>
                            <Button htmlType="button" onClick={() => history.push(slugs.fruitEvent)} className="btn_reset__product_create">Hủy</Button>
